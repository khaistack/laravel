...
@section('content')
    <div class="container">
        <div class="devise-section">
            <h1 class="text-">Create Free Forever Account</h1>
            <div class="row">
                {{-- <div class='#'> --}}
                    <div class='col-12  col-md-7'>
                        <div class=" featured-block">
                            <form class="new_user" action="{{ route('register') }}" accept-charset="UTF-8" method="POST">
                                @csrf
                                <div class="mbs mt-4">
                                    <div class="row ptm-edit mt-2">
                                        ...
                                        {{-- @endif --}}
                                        <label class="left col-md-5" for="user_password">Name</label>
                                    </div>
                                    <input type="text" name="name" class='input_text' id="user_password">
                                ...
                                <div class="mbs mt-4">
                                    ...
                                    {{-- @endif --}}
                                    <input type="password" name="password" class='input_text' id="user_password">
                                ...
                                <div class="separated-block separated-block-login">
                                    <div class="mt-2">
                                        <button class="singinwithemail edit-button-login col-md-4">
                                            <span class="text-normal"> Sing in </span>
                                        </button>
                                    </div>
                                    <div class="edit-text-re">
                                        <a target="_blank" rel="noopener noreferrer" class="device__resend-link"
                                            href="/terms"></a>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class=" mt-5 featured-block">
                            <span>Lorem ipsum dolor sit amet consectetur, ignissimos eaque voluptate cum. Animi, nisi
                                deserunt!</span>
                        </div>
                    </div>
                </div>
